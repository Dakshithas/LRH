    ...
    <div class="table-responsive">
        <div class="table-wrapper">
                    ...
                    <div class="col-md-12">
                        <div class="search-box float-right">
                            <div class="input-group">
                                <input type="text" id="search" onkeyup="myFunction()" class="form-control" placeholder="Search by Name">
            ...
            <div style="overflow-x:auto;">
                <table id="Pm" class="table table-striped">
                    <thead>
                        <tr>
                            <!-- <th>#</th> -->
                        ...
                        <div class="col-md-7 bg-white rounded-right m-0 p-0">
                            ...
                            <form method="POST">
                                <div class="row p-0 m-0" style='width:100%'>
                                    <input type="" name="id" id="patient_id">
                                    <div class="col-sm-3">
    ...
    <script>
        $(document).ready(function() {
            $('.editbtn').on('click', function() {
                ...
                var modal = $('#editmodal');
                modal.find('.name').text(data[4]);
                modal.find('.mnumber').text(data[6]);
                modal.find('.email').text('email: ' + data[2]);
                modal.find('.address').text(data[5]);
