...
<div class="col-md-8 col-sm-10" style="padding:30px">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="btn-group mr-2" role="group" aria-label="First group">
                            <a href='?type=patient' class="btn btn-secondary active" role="button" aria-pressed="true">Patients</a>
                            <a href='?type=physio' class="btn btn-secondary" role="button" aria-pressed="true">Physiotheraphist</a>
                            <a href='?type=recep' class="btn btn-secondary" role="button" aria-pressed="true">Receptionist</a>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <?php endif; ?>
                                        <button type="button" class="btn btn-link deletebtn" data-toggle="modal" data-target="#deletemodal"><i class="fa fa-trash-o fa-3x" style="color: #F92525;" aria-hidden="true"></i></button></div>
                                </td>
                        ...
                        <div class="col-md-7 bg-white rounded-right m-0 p-0">
                            ...
                            <div class="row" style="width:100%; margin:0px">
                                <div class="col-md-6" style="text-overflow: ellipsis;">
                                    <center>
                                        ...
                                        <p class='text-dark physio m-0'></p>
                                    </center>
                                </div>
                                <div class="col-md-6">
                                    <center>
                            ...
                            <form method="POST">
                                <div class="row p-0 m-0" style='width:100%'>
                                    <input type="hidden" name="id" id="fname">
                                    <!-- <div class="col-sm-3">
                                    ...
                                    <!-- <div class="col-sm-3 p-0 m-0">
                                        <center>
                                            <button class="btn btn-link" type="submit" formaction="<?php echo URLROOT; ?>/appoinment/calendar"><i class='fa fa-calendar-plus-o fa-3x' style="color: #0E92EF;" aria-hidden='true'></i></button>
    ...
    <div class="modal fade delete" id='deletemodal' tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete this profile? This process can not be undone.
                </div>
                <div class="modal-footer">
                    <form action="" method="post">
                        <input type="hidden" name="delete_id" id="delete_id">
                        <button type="submit" class="btn btn-danger" name='submit'>Confirm Deletion</button>
    ...
    <script>
        $(document).ready(function() {
            $('.deletebtn').on('click', function() {
                // var delete_id = $(this).closest('tr').find("#delete_id");
    ...
    <script>
        $(document).ready(function() {
            $('.editbtn').on('click', function() {
                ...
                var modal = $('#editmodal');
                modal.find('.name').text(data[1]);
                modal.find('.mnumber').text(data[4]);
                modal.find('.email').text('email: ' + data[2]);
                modal.find('.address').text(data[3]);
                modal.find('.physio').text(data[6]);
